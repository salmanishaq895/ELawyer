...
if (isset ($_GET['id']))
{
	$_SESSION['redirect']['page'] = trim($_GET['id'] );
...
$user_id = $_SESSION['TTLOGINDATA']['USERID'];
...
<div class="map_page_right_bar listing_right_bar">
  ...
  <div class="map_page_right_bar">
    ...
    <div class="profile_page_left">
      <div class="listing_wrapper_left"> <span style="width:97%;">Send Message To Trader ( <?php echo $job_name; ?> )</span></div>
