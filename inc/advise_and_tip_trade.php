<?php
	$query_cms = "SELECT * FROM tt_cms WHERE type = 'advise_and_tip_for_trader' " ; 
	...
	<div class="map_page_right_bar terms_condition_bar">
		<div class="brued_crum_bar brued_crum_bar_c">
			<div class="listing_page_brued_crum">
				<span class="brurd_curm_inner"><a href="<?php echo $ru;?>" style="text-decoration:none; color:#999999;">Home</a> ><a href="<?php echo $ru;?>advise_and_tip_trade" style="text-decoration:none; color:#999999;"> <span class="change">Advise and tip for trader</span></a></span>
			</div>
		</div>
			
		<div class="profile_page_left">
			<div class="company_detail_description">
				<span class="company_detail_span">Advise and tip for trader</span>
