...
<br>
<br>
<textarea style="font-size:12px;font-family:arial;width:333px;" rows="10" ><a target="_blank" href="<?php echo $ru ; ?>profile/<?php echo $row_buss['locationid'].'_'. encodeURL(stripslashes($row_buss['name']))."/"; if($row_buss['industry']!=''){echo encodeURL(stripslashes($row_buss['industry']))."/";}    if($row_buss['city']!=''){ echo encodeURL(stripslashes($row_buss['city']))."/";} if($row_buss['state']!=''){echo encodeURL(stripslashes($row_buss['state']))."/";} echo $row_buss['zip'] ; ?>"><img src="<?php echo $ru;?>images/gad2011_txt1.gif" alt="<?php echo $row_buss['name']; ?>" border="0"></a><script src="<?php echo $ru;?>/widget/ratting.php?bid=<?php echo$row_buss['locationid'];  ?>&type=5" type="text/javascript"></script></textarea>
