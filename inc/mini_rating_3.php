...
<br>
<br>
<textarea style="font-size:12px;font-family:arial;width:333px;" rows="10" ><script src="<?php echo $ru;?>widget/ratting.php?bid=<?php echo $row_buss['locationid'];?>&type=6" type="text/javascript"></script></textarea>
