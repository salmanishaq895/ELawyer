...
<div class="content-box">
	...
	<?php } ?>
<form action="process.php?p=addsubcat" method="post">
			...
			?>
			  ...
			  <tr>
				...
				<td valign="middle">
				    ...
				    <img src="images/dlt.gif"  style="cursor:pointer;" title="Delete Sub-Category" alt="Delete Sub-Category" onclick="if(confirm('Are sure you want to delete')){window.location='process.php?p=delsubcat&page=<?php echo $_GET['page'];?>&cid=<?php echo $items["catid"]; ?>&kw=<?php echo $items["cat_name"]; ?>' }"  />
				</td>
		      </tr>	
			  <tr>
			   <td colspan="4"><div id="<?php echo $items['catid'];?>" style="display:none;">
			   <form action="process.php?p=editsubcategory&cid=<?php echo $items['catid'];?>&page=<?php echo $_GET['page'];?>" method="post">
