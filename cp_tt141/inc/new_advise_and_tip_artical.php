...
<h3><a href="#">Home</a> &raquo; <a href="#" class="active">Article Post Management</a></h3>
<div class="content-box">
	<div class="content-box-header">
		<h3>Article Post Management</h3>
		<div class="clear"></div>
	</div>
...
<label>  Select Advice Category:&nbsp;</label>
		...
		<?php 
					...
					<option <?php if($row_cat['advise_id'] == $row_cat['advise_id']){ ?> selected="selected" <?php } ?> value="<?php echo $row_cat['advise_id'].",".$id;?>"><?php echo $row_cat['advise_title'];?></option>					
		...
		<input name="meta_title" id="meta_title" type="text" class="text-input medium-input"  value="<?php echo $_SESSION['biz_reg']['meta_title']; ?>"  />
        <p> 
		<p>
		
		<label> Meta Keyword:&nbsp;&nbsp;&nbsp;</label>
		<input name="metakeyword" id="metakeyword" type="text" class="text-input medium-input"  value="<?php echo $_SESSION['biz_reg']['metakeyword']; ?>" > 
        </p>
		 
		 	 <p> 
		<label> Meta Description :&nbsp;&nbsp;&nbsp;</label>
				<input name="meta_desc" id="meta_desc" type="text" class="text-input large-input"  value="<?php echo $_SESSION['biz_reg']['meta_desc']; ?>" > 
        </p> 
		...
		<input name="sublink"  id="sublink" type="checkbox" <?php if( $_SESSION['biz_reg']['sublink']!='0'){ ?> checked="checked" <?php } ?> value="1" />
        </p>
...
<label> 	Short Description:&nbsp;&nbsp;&nbsp;</label>
			...
			<textarea name="advise_short_description" id="advise_short_description" cols="4" rows="5" ><?php echo $_SESSION['biz_reg']['advise_short_description']; ?> </textarea>
...
<label> 	 Description:&nbsp;&nbsp;&nbsp;</label>
		...
		$oFCKeditor->Value = $_SESSION['biz_reg']['advise_description'];
		$oFCKeditor->Create();
		?>
	</p>
	<P>
	<input type="submit" class="button" name="Artical" value="Save">
