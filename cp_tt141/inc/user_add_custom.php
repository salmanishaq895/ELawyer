<h3><a href="<?php echo $ruadmin; ?>home.php?p=user_manage">Advocates</a> &raquo; <a href="#" class="active">Add New Advocate User</a></h3>
<div class="content-box">
	<div class="content-box-header">
		<h3>Add New Advocate User</h3>
		<div class="clear"></div>
	</div>
			...
			<fieldset>
                ...
                <p>
                	<label>Photo:</label>
                        ...
                        <input name="logo" id="logo" type="file"  />&nbsp;&nbsp;&nbsp;(image size 350 X 250 )
                </p>
                <p><label>Description:</label>
                            <textarea id="des" type="text" cols="72" rows="4" name="des"><?php echo $_SESSION['user_reg']['des']?></textarea>
                            </p>
				...
				<p style="width:100%"  >
				<input type="submit" class="button" value="&nbsp;&nbsp;&nbsp;Save&nbsp;&nbsp;&nbsp;" name="AddCustom" id="submit" />
				</p>
			</fieldset>
		</form>
		</div>
