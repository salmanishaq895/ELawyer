...
$t.='
	...
	$sql_sel_user = "SELECT tt_user.email, tt_user.firstname, tt_user.lastname, tt_user.zip, tt_user.city, tt_user.state FROM `tt_user` $innerJoin $qryString and tt_user.type = 'u' $sortyby ";  
  ...
  <?php } ?>	
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  ...
	  <tr>
		...
		<tr>
			<td>
			<input type="submit" class="button" name="SaveTextData_customer" value="Send Email Customer" /></td>
		</tr>
	</table>
