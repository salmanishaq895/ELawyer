...
<h3><a href="#">Home</a> &raquo; <a href="#" class="active">Edit Advice & tips Sub Category Management</a></h3>
<div class="content-box">
	<div class="content-box-header">
		<h3>Edit Advice & tips Sub Category Management</h3>
		<div class="clear"></div>
	</div>
...
<label> Select Post Category:&nbsp;</label>
		...
		?>
			...
			<option <?php if($_SESSION['biz_regg']['category_id'] == $row_cat['advise_id']){ ?> selected="selected" <?php } ?> value="<?php echo $row_cat['advise_id'];?>"><?php echo $row_cat['advise_title'];?></option>					
		...
		<input name="advise_title" id="advise_title" type="text" class="text-input small-input"  value="<?php echo $_SESSION['biz_regg']['advise_title']; ?>" onkeyup="friendly_url_abc(this.value,100);"/>
       </p>
	   <p> 
	   <label>
	   Seo Page Name:&nbsp;&nbsp;&nbsp;</label>
...
<label> 	Short Description:&nbsp;&nbsp;&nbsp;</label>
			...
			<textarea name="advise_description" id="advise_description" cols="4" rows="5" >  <?php echo stripcslashes($htmlData);?></textarea>
			
		
	</p>
	
	<p> 
	<input type="submit" class="button" name="EditAdvise" value="Update">
	    <input type="hidden" name="advise_id" value="<?php echo $type;?>"  />
	  </p>
	  </fieldset>
	  </form>
	</div>
