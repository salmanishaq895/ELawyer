...
{ ?> 
	<h3><a href="<?php echo $ruadmin; ?>home.php?p=user_manage">Advocate</a> &raquo; <a href="#" class="active">Edit Advocate Profile</a></h3> 
<?php }else{?>
	<h3><a href="<?php echo $ruadmin; ?>home.php?p=user_manage">MyInfo</a> &raquo; <a href="#" class="active">Edit Advocate Profile</a></h3>
<?php } ?>
<div class="content-box">
	<div class="content-box-header">
	<?php if($_SESSION['cp_tt']['userId'] != $userId ) { ?> 
		<h3>Edit Advocate Profile</h3> 
	<?php }else{?>
		<h3>Edit Advocate Profile</h3>
	<?php } ?>
		<div class="clear"></div>
	...
	<div class="content-box-content">                    
			...
			<?php } unset ($_SESSION['user_update_err']);  ?>					
                ...
                <div id="main">
                	...
                	<form  method="post" action="process/process_user.php" enctype="multipart/form-data">
                    <input type="hidden" name="userId" id="userId" value="<?php echo $userId ?>"  /> 
                    	<fieldset>
							...
							<p><label>Last Name:</label><input name="lastname" id="lastname" type="text" class="text-input small-input"  value="<?php echo $_SESSION['user_update']['lastname']; ?>"/></p>
                             ...
                             <p><label>Photo:</label><?php if(isset($_SESSION['user_update']['photo']) and $_SESSION['user_update']['photo']!=""){ ?>	
							
						<img src="<?php echo $ru."media/Advocate/".$_SESSION['user_update']['userId']."/photo/thumb/".$_SESSION['user_update']['photo'];?>" title="thumb" alt="" /><?php } ?>
                        <input name="logo" id="logo" type="file" value="<?php echo $_SESSION['user_update']['photo'];?>" />&nbsp;&nbsp;&nbsp;(image size 350 X 250 )
							<input type="hidden" name="oldImg" value="<?php echo $_SESSION['user_update']['phot'];?>" />
                        </p>
                        	<p><label>Description:</label>
                            <textarea id="des" type="text" cols="72" rows="4" name="des"><?php echo $_SESSION['user_update']['des']?></textarea>
                            </p>
                        	...
                        	<?php } ?>
							<p style="width:100%">
                            <input type="submit" class="button" value="&nbsp;&nbsp;&nbsp;Update&nbsp;&nbsp;&nbsp;" name="UpdateUserCustom" id="UpdateMember2" />
                            </p>
                        </fieldset>
                    </form>
                </div>
