...
if ( isset ($_POST['doSearch'] ) || isset ($_POST['do_Search'] ) ) 
{
	...
	header("location:".$ruadmin."home.php?p=banner_manage_image2");exit;
}
$qryString = " where 1 and banner_type ='image2'  ";
...
?>
<h3><a href="#">Home</a> &raquo; <a href="#" class="active">Bottom Image Banner Management</a></h3>
<div class="content-box">
	<div class="content-box-header">
			<h3>Bottom Image Banner Management</h3>
		<div class="clear"></div>
	</div>
